...
// source: bze/tradebin/v1/order.proto
...
func (*Order) Descriptor() ([]byte, []int) {
	return fileDescriptor_ad5d5030337bca5f, []int{0}
}
...
func (*OrderReference) Descriptor() ([]byte, []int) {
	return fileDescriptor_ad5d5030337bca5f, []int{1}
}
...
func (*AggregatedOrder) Descriptor() ([]byte, []int) {
	return fileDescriptor_ad5d5030337bca5f, []int{2}
}
...
func (*HistoryOrder) Descriptor() ([]byte, []int) {
	return fileDescriptor_ad5d5030337bca5f, []int{3}
}
...
func (*UserDust) Descriptor() ([]byte, []int) {
	return fileDescriptor_ad5d5030337bca5f, []int{4}
}
...
func init() { proto.RegisterFile("bze/tradebin/v1/order.proto", fileDescriptor_ad5d5030337bca5f) }

var fileDescriptor_ad5d5030337bca5f = []byte{
	// 398 bytes of a gzipped FileDescriptorProto
	,
}
