...
export interface V1BurnedCoins {
  burned?: string;
  height?: string;
}
...
/**
 * @title burner/burn_coins_proposal.proto
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  queryAllBurnedCoins = (
    ...
    this.request<V1QueryAllBurnedCoinsResponse, RpcStatus>({
      path: `/bze/burner/v1/all_burned_coins`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/bze/burner/v1/params
   */
