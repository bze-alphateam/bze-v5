...
export const Raffle = {
  ...
  fromJSON(object: any): Raffle {
    ...
    if (object.totalWon !== undefined && object.totalWon !== null) {
      message.totalWon = String(object.totalWon);
    } else {
      message.totalWon = "";
    }
    return message;
  ...
  toJSON(message: Raffle): unknown {
    ...
    message.totalWon !== undefined && (obj.totalWon = message.totalWon);
    return obj;
  },
...
export const RaffleParticipant = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          break;
        case 4:
          message.executeAt = longToNumber(reader.int64() as Long);
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromJSON(object: any): RaffleParticipant {
    ...
    if (object.executeAt !== undefined && object.executeAt !== null) {
      message.executeAt = Number(object.executeAt);
    } else {
      message.executeAt = 0;
    }
    return message;
  ...
  toJSON(message: RaffleParticipant): unknown {
    ...
    message.executeAt !== undefined && (obj.executeAt = message.executeAt);
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<RaffleParticipant>): RaffleParticipant {
    ...
    if (object.executeAt !== undefined && object.executeAt !== null) {
      message.executeAt = object.executeAt;
    } else {
      message.executeAt = 0;
    }
    return message;
