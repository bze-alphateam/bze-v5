 ...
 * Params defines the parameters for the module.
 */
export interface V1PublisherRespectParams {
  tax?: string;
  denom?: string;
}
...
export interface V1QueryAllAnonArticlesCountersResponse {
  AnonArticlesCounters?: V1AnonArticlesCounter[];
...
export interface V1QueryAllArticlesResponse {
  article?: V1Article[];
...
/**
 * @title cointrunk/accepted_domain.proto
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  queryAcceptedDomain = (
    ...
    this.request<V1QueryAcceptedDomainResponse, RpcStatus>({
  ...
  queryAllAnonArticlesCounters = (
    ...
    this.request<V1QueryAllAnonArticlesCountersResponse, RpcStatus>({
  ...
  queryAllArticles = (
    ...
    this.request<V1QueryAllArticlesResponse, RpcStatus>({
  ...
  queryPublisherByIndex = (index: string, params: RequestParams = {}) =>
    this.request<V1QueryPublisherByIndexResponse, RpcStatus>({
  ...
  queryPublisher = (
    ...
    this.request<V1QueryPublisherResponse, RpcStatus>({
