...
import { Module as BzeBurnerV1, msgTypes as BzeBurnerV1MsgTypes } from './bze.burner.v1'
import { Module as BzeCointrunkV1, msgTypes as BzeCointrunkV1MsgTypes } from './bze.cointrunk.v1'
import { Module as BzeEpochsV1, msgTypes as BzeEpochsV1MsgTypes } from './bze.epochs.v1'
import { Module as BzeScavenge, msgTypes as BzeScavengeMsgTypes } from './bze.scavenge'
import { Module as BzeTokenfactoryV1, msgTypes as BzeTokenfactoryV1MsgTypes } from './bze.tokenfactory.v1'
import { Module as BzeTradebinV1, msgTypes as BzeTradebinV1MsgTypes } from './bze.tradebin.v1'
import { Module as BzeV1Rewards, msgTypes as BzeV1RewardsMsgTypes } from './bze.v1.rewards'
...
const Client = IgniteClient.plugin([
    BzeBurnerV1, BzeCointrunkV1, BzeEpochsV1, BzeScavenge, BzeTokenfactoryV1, BzeTradebinV1, BzeV1Rewards, CosmosAuthV1Beta1, CosmosAuthzV1Beta1, CosmosBankV1Beta1, CosmosBaseTendermintV1Beta1, CosmosCrisisV1Beta1, CosmosDistributionV1Beta1, CosmosEvidenceV1Beta1, CosmosFeegrantV1Beta1, CosmosGovV1, CosmosGovV1Beta1, CosmosMintV1Beta1, CosmosNftV1Beta1, CosmosParamsV1Beta1, CosmosSlashingV1Beta1, CosmosStakingV1Beta1, CosmosTxV1Beta1, CosmosUpgradeV1Beta1, CosmosVestingV1Beta1, IbcApplicationsInterchainAccountsHostV1, IbcApplicationsTransferV1, IbcCoreChannelV1, IbcCoreClientV1, IbcCoreConnectionV1
]);

const registry = new Registry([
  ...BzeBurnerV1MsgTypes,
  ...BzeCointrunkV1MsgTypes,
  ...BzeEpochsV1MsgTypes,
  ...BzeScavengeMsgTypes,
  ...BzeTokenfactoryV1MsgTypes,
  ...BzeTradebinV1MsgTypes,
  ...BzeV1RewardsMsgTypes,
