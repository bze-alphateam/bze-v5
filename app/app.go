...
import (
	...
	v720 "github.com/bze-alphateam/bze/app/upgrades/v720"
...
func New(
	...
	app.sm = module.NewSimulationManager(
		...
		ibc.NewAppModule(app.IBCKeeper),
		transferModule,
		cointrunkmodule.NewAppModule(appCodec, app.CointrunkKeeper, app.AccountKeeper, app.BankKeeper, app.DistrKeeper),
...
func (app *App) setupUpgradeHandlers(cfg module.Configurator) {
	app.UpgradeKeeper.SetUpgradeHandler(
		v720.UpgradeName,
		v720.CreateUpgradeHandler(cfg, app.mm),
	)
}
