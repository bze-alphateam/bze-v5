...
// AddGenesisAccountCmd returns add-genesis cobra Command.
...
// AddGenesisAccountStarportCmd returns add-genesis-account cobra Command.
func AddGenesisAccountStarportCmd(defaultNodeHome string) *cobra.Command {
	cmd := &cobra.Command{
